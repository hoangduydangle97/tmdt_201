...
<html lang="zxx">
    <head>
        ...
        <!-- Google Font -->
        <link rel="stylesheet" href="./public/css/google-font.css" type="text/css">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <nav class="header__menu">
                            <ul>
                                <li <?php if($data["page"] == "home"){ ?>class="active"<?php }?>><a href="./home">Home</a></li>
                                <li><a href="./shop-grid.html">Shop</a></li>
                                <li><a href="#">Pages</a>
                                    <ul class="header__menu__dropdown">
                                        <li><a href="./shop-details.html">Shop Details</a></li>
                                ...
                                <li <?php if($data["page"] == "blog"){ ?>class="active"<?php }?>><a href="./blog">Blog</a></li>
                                <li <?php if($data["page"] == "contact"){ ?>class="active"<?php }?>><a href="./contact">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-lg-3">
